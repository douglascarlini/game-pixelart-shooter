    ...
    static ship(s = 128) {
        ...
        item.custom = function () {
            ...
            if (Game.pad[90] && this.aux.shotCnt > 5) {
                ...
                var { x, y } = Calc.orb(this.pos.x, this.pos.y, this.pos.r + 50, 10);
                Make.shot(x, y, this.pos.r);
                Make.capsule(x, y);

                var { x, y } = Calc.orb(this.pos.x, this.pos.y, this.pos.r + 40, 10);
