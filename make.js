class Make {
    ...
    static ship(s = 128) {
        ...
        item.custom = function () {
            ...
            if (this.aux.shotCnt > 5) {
                var x = Calc.rnd(this.siz.w);
                var y = Calc.rnd(this.siz.h);
    ...
    static trail(x, y, z, r, s = 96) {
        ...
        var item = new Item({ cat: 'fire', pos: { x, y }, siz: { w: s, h: s }, spr: { img: Game.img.fire, len: 10, rep: false, die: true, w: s, h: s } });
